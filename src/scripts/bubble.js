...
class Bubble {
   ...
   * @param {string} [params.style=h5p-interactive-360-video-bubble] - Selector for the CSS base class.
   * @param {string} [params.mode=centered] - 'centered' or 'full' (could be extended)
   * @return {Bubble} The bubble.
   */
  constructor($reference, params = {content: '', maxWidth: 'auto', style: 'h5p-interactive-360-video-bubble', mode: 'centered', focus: () => {}}) {
    ...
    this.$h5pContainer = this.$reference.closest('.h5p-interactive-360-video');
