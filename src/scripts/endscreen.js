/**
 * H5P Interactive 360 Video - Endscreen Module
 * 
...
const ENDSCREEN_STYLE_BASE = 'h5p-interactive-360-video-endscreen';
const ENDSCREEN_STYLE_BUTTON_HIDDEN = 'h5p-interactive-360-video-endscreen-submit-button-hidden';
...
class Endscreen extends H5P.EventDispatcher {
   ...
   *
   * @param {object} parent - Parent object, right now quite tied to Interactive 360 Video.
  ...
  buildTableRow(time, title, score, maxScore) {
    ...
    $('<div/>', {
      ...
      html: H5P.Interactive360Video.humanizeTime(time),
      appendTo: $row,
      'aria-hidden': true
    });
